...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select service_status_marketing,service_id, offer_no, dbo.f_convertDatetochar(offer_date)str_offer_date, offer_date,customer_name, grand_price,net,marketing_id,branch_name, reason_marketing from v_opr_service where service_status_id='2' and offer_no like @no and marketing_id like (select case when all_access=1 then '%' else marketing_id end from act_marketing where user_id=@user) and customer_name like @cust and service_id in (select service_id from v_opr_service_device where sn like @sn) and branch_id like @branch">
        <SelectParameters>
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="service_status_marketing" HeaderText="Status" ReadOnly="True" SortExpression="service_status_marketing" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right"/>
