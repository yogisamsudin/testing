...
<script runat="server">
    public string function_edit_name = "list_edit", function_add_name = "list_add", str_style_add = "";    
    ...
    void Page_Load(object o, EventArgs e)
    {
        ...
        if (Request.QueryString["vadd"] != null) str_style_add = "visibility:hidden;";
        gvdata.DataBind();
    }
</script>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="aspx_fin_service_list"
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-Width="25px">
                ...
                <HeaderTemplate>
                    <div class="tambah" title="tambah" onclick="tambah()"  style="<%= str_style_add %>"></div>
                </HeaderTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="invoice_service_id" HeaderText="Kode Print" ReadOnly="True" SortExpression="invoice_service_id" HeaderStyle-HorizontalAlign="Left" /> 
