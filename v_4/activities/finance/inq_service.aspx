    ...
    <script type="text/javascript">
        var cari = {
            ...
            load: function () {
                ...
                cari.fl.src = "fin_service_list.aspx?vadd=1&no=" + no + "&kf=" + cari.tb_kode.value + "&cust=" + cust + "&paid=" + cari.cb_paid.checked + "&branch=%&offer=" + nooffer;
            },
            fl_refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                tbl_load: function (id) {
                    activities.fin_service_opr_list(id,
                        function (arrData) {
                ...
                edit:function(id)
                {
                    activities.fin_service_data(id,
                        function (data)
                        {
                            ...
                            mdl.showEdit("Inquery Invoice Service");
                        }, apl.func.showError, ""
                    );                    
                }
