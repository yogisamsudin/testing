...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select invoice_sales_id,invoice_date,dbo.f_convertDateToChar(invoice_date)str_invoice_date,Invoice_no,customer_name,grand_price,total_ppn from v_fin_sales where paid_sts=0 and invoice_no like @no and invoice_sales_id not in (select invoice_sales_id from fin_receivable_sales)">
        <SelectParameters>
