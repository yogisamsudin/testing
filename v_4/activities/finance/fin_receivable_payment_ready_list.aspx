...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select reverse_sign_sts,case when reverse_sign_sts = 1 then 'checked=''checked''' else '' end html_reversesign, fin_receivable_id,type_transaction, transaction_date,invoice_no,dbo.f_convertDateToChar(transaction_date) str_transaction_date,pph_amount,receivable_amount,customer_name,type_transaction from v_fin_receivable where receivable_status_id='1' and invoice_no like @no">
        <SelectParameters>
