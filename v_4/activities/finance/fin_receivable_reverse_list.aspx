...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select fin_receivable_reverse_id, dbo.f_convertDateToChar(transaction_date)strtransaction_date,transaction_date, transaction_type,invoice_no from v_fin_receivable_reverse where invoice_no like @no">
        <SelectParameters>
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-Width="25px">
                <ItemTemplate>
                    <div class="edit" title="edit" onclick="edit('<%# Eval("fin_receivable_reverse_id") %>');"></div>
                </ItemTemplate>
                <HeaderTemplate>
                    <div class="tambah" title="tambah" onclick="tambah()"></div>
                </HeaderTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="strtransaction_date" HeaderText="Tanggal" ReadOnly="True" SortExpression="transaction_date" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100px"/>
            ...
            <asp:BoundField DataField="transaction_type" HeaderText="Tipe" ReadOnly="True" SortExpression="transaction_type" HeaderStyle-HorizontalAlign="Left" />
        </Columns>
    </asp:GridView>
