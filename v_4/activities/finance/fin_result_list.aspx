...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select result_id, result from v_fin_result where result like @result">
        <SelectParameters>
            <asp:QueryStringParameter Name="result" QueryStringField="result" DefaultValue=" "/>            
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-Width="25px">
                <ItemTemplate>
                    <div class="edit" title="edit" onclick="edit('<%# Eval("result_id") %>');"></div>
                </ItemTemplate>
                <HeaderTemplate>
                    <div class="tambah" title="tambah" onclick="tambah()"></div>
                </HeaderTemplate>
            </asp:TemplateField>            <asp:BoundField DataField="result" HeaderText="Keterangan" ReadOnly="True" SortExpression="result" HeaderStyle-HorizontalAlign="Left" />
