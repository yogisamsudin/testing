...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select bill_id, bill_no, bill_name, bill_bank_name from v_fin_bill where bill_no like @no">
        <SelectParameters>
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-Width="25px">
                <ItemTemplate>
                    <div class="edit" title="edit" onclick="edit('<%# Eval("bill_id") %>');"></div>
                </ItemTemplate>
                <HeaderTemplate>
                    <div class="tambah" title="tambah" onclick="tambah()"></div>
                </HeaderTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="bill_no" HeaderText="No" ReadOnly="True" SortExpression="bill_no" HeaderStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="bill_name" HeaderText="Nama" ReadOnly="True" SortExpression="bill_name" HeaderStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="bill_bank_name" HeaderText="Bank" ReadOnly="True" SortExpression="bill_bank_name" HeaderStyle-HorizontalAlign="Left" />
        </Columns>
    </asp:GridView>
