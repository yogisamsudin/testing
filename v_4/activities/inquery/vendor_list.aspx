...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="phone1" HeaderText="Telp." ReadOnly="True" SortExpression="phone1" HeaderStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="contact_name" HeaderText="Contact" ReadOnly="True" SortExpression="contact_name" HeaderStyle-HorizontalAlign="Left" />
        </Columns>
    </asp:GridView>
