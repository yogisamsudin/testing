    ...
    <script type="text/javascript">
        var cari = {
            ...
            load: function () {
                ...
                cari.fl.src = "wageparam_list.aspx?name=" + name;
            },
            fl_refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                dl_type:apl.createDropdownWS("mdl_type",activities.dl_hr_wageparam_type),
                ...
                edit: function (id) {
                    ...
                    activities.hr_wageparam_data(id,
                        function (data) {
                            mdl.tb_name.value = data.wageparam_name;
                            mdl.dl_type.value = data.type_id;
            ...
            function () {
                if (apl.func.validatorCheck("save")) {
                    ...
                    activities.hr_wageparam_add(mdl.tb_name.value,mdl.dl_type.value, mdl.close, apl.func.showError, "");
                }
            },
            function () {
                if (apl.func.validatorCheck("save")) {
                    apl.func.showSinkMessage("Menyimpan Data");
                    activities.hr_wageparam_edit(mdl.id, mdl.tb_name.value,mdl.dl_type.value, mdl.close, apl.func.showError, "");
                }
            },
            function () {
                if (confirm("Yakin akan dihapus?")) activities.hr_wageparam_delete(mdl.id, mdl.close, apl.func.showError, "");
