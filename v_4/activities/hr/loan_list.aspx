...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select loan_id,dbo.f_convertDateToChar(loan_date)str_loan_date,tenor,loan_amount,loan_no,loan_start_month_name,loan_start_year,employee_name from v_hr_employee_loan where approve_sts=1 and employee_name like @name">
        <SelectParameters>
