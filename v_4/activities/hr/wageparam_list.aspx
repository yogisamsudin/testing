...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="SELECT wageparam_id, wageparam_name FROM v_hr_wageparam where wageparam_name like @name">
        <SelectParameters>
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-Width="25px">
                <ItemTemplate>
                    <div class="edit" title="edit" onclick="edit(<%# Eval("wageparam_id") %>);" style="float:left"></div>                    
                </ItemTemplate>
                <HeaderTemplate>
                    <div class="tambah" title="tambah" onclick="tambah(0)"></div>
                </HeaderTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="wageparam_name" HeaderText="Nama" ReadOnly="True" SortExpression="wageparam_name" HeaderStyle-HorizontalAlign="Left" />
