    ...
    <script>
        var cari = {
            ...
            load: function () {
                ...
                cari.fl_list.src = "merk_list.aspx?name=" + name;
            },
            refresh: function () {
        ...
        var mdl = apl.createModal("mdl",
            {
                ...
                edit: function (id) {
                    ...
                    activities.par_merk_data(id,
                        function (data) {
                            mdl.tb_name.value = data.merk_name;
            ...
            function () {
                if (apl.func.validatorCheck("save")) {
                    ...
                    activities.par_merk_add(mdl.tb_name.value, mdl.close, apl.func.showError, "");
                }
            },
            function () {
                if (apl.func.validatorCheck("save")) {
                    apl.func.showSinkMessage("Menyimpan...");
                    activities.par_merk_edit(mdl.merk_id, mdl.tb_name.value, mdl.close, apl.func.showError, "");
                }
            },
            function () {
                if (confirm("Yakin akan dihapus?")) {
                    apl.func.showSinkMessage("Menghapus...");
                    activities.par_merk_delete(mdl.merk_id, mdl.close, apl.func.showError, "");
                }
