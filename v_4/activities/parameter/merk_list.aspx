...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select merk_id, merk_name from par_merk where merk_name like @name">
        <SelectParameters>
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-Width="25px">
                <ItemTemplate>
                    <div class="edit" title="edit" onclick="edit('<%# Eval("merk_id") %>');"></div>
                </ItemTemplate>        
                <HeaderTemplate>
                    <div class="tambah" onclick="tambah();"></div>
                </HeaderTemplate>        
            </asp:TemplateField>
            <asp:BoundField DataField="merk_name" HeaderText="Nama" ReadOnly="True" SortExpression="merk_name" HeaderStyle-HorizontalAlign="Left" />            
        </Columns>
    </asp:GridView>
