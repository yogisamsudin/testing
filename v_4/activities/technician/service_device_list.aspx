...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ConnectionString="<%$ ConnectionStrings:csApp %>" SelectCommand="aspx_service_device_list" SelectCommandType="StoredProcedure" DataSourceMode="DataSet">
        <SelectParameters>
            ...
            <asp:QueryStringParameter Name="status_send" QueryStringField="status_send" DefaultValue=""/>
            <asp:QueryStringParameter Name="inventory" QueryStringField="inventory" DefaultValue=""/>
