...
<asp:Content ID="Content1" ContentPlaceHolderID="Body_Content" Runat="Server">
    <asp:SqlDataSource runat="server" ID="sdsdata" 
        ...
        SelectCommand="select device_type_id, device_type,part_sts, case when part_sts=1 then 'checked' else '' end status from v_tec_device_type where device_type like @type and part_sts=@ps">
        <SelectParameters>
    ...
    <asp:GridView runat="server" ID="gvdata" DataSourceID="sdsdata" 
        ...
        <Columns>
            <asp:TemplateField HeaderStyle-Width="25px">
                <ItemTemplate>
                    <div class="edit" title="edit" onclick="edit('<%# Eval("device_type_id") %>');"></div>
                </ItemTemplate>
                <HeaderTemplate>
